...
public class RootTreeSelectionModel implements TreeSelectionModel {
	TreeSelectionModel selectionModel = new DefaultTreeSelectionModel();
	JTree tree;

	public RootTreeSelectionModel(JTree tree) {
		this.tree = tree;
	}
	
    private boolean canPathBeAdded(TreePath treePath) {
        return (!(treePath.getLastPathComponent().equals(tree.getModel().getRoot())));
    }
