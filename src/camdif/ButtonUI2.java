...
public class ButtonUI2 extends BasicButtonUI {
		...
		if (button.isOpaque()) {
			...
			if (button.getModel().isPressed()) {
				GradientPaint gp = new GradientPaint(
						...
						0, BUTTON_HEIGHT * 0.6f, new Color(245, 245, 245), true);
				g2d.setPaint(gp);
			} else if (button.getModel().isRollover()) {
				RadialGradientPaint gp = new RadialGradientPaint(new Point(buttonWidth / 2, BUTTON_HEIGHT / 2),
						buttonWidth,
						new float[] { 0.2f, 0.8f },
						new Color[] { new Color(240, 240, 240), new Color(240, 240, 240) });
				g2d.setPaint(gp);
			} else if (button.isEnabled()) {
				GradientPaint gp = new GradientPaint(
						0, 0, new Color(235, 235, 235),
						0, BUTTON_HEIGHT * 0.6f, new Color(235, 235, 235), true);
				g2d.setPaint(gp);
			} else {
				GradientPaint gp = new GradientPaint(
